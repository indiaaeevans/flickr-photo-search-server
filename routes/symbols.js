...
const symbols = ['exclamation', 'ampersand', 'questionmark', 'period', 'hash', 'percent', 'plus', 'equals', 'comma', 'apostrophe', 'slash', 'quote', 'asterisk', 'dollar'];

router.get('/', function (req, res, next) {

    symbols.forEach((symbol) => {
        utils.getPhotoCollection(process.env.flickrKey, symbolsGroup, symbol);
    })
